...
<div class="wrap">
	...
	<h2><?php _e( 'WP Featured Post :- Features', 'featured-post' ); ?></h2><br />
	...
	<table class="wpos-plugin-pricing-table">
		...
		<colgroup></colgroup>	
	    	...
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>WP Featured Post</strong> included in <br /><strong>Essential Plugin Bundle</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>WP Featured Post</strong> included in <br /><strong>Essential Plugin Bundle</p>
		...
		<tbody>
			...
			<tr>
			<th>Visual Composer/WPBakery Page Builder Supports <span class="subtext">Use this plugin with Visual Composer easily</span></th>
			<td><i class="dashicons dashicons-no-alt"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>
