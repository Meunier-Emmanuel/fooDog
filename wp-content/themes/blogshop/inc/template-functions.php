...
if (!function_exists('blogshop_footer_credit')) {
	function blogshop_footer_credit(){
		return '<strong>'.__(' Theme:&nbsp;', 'blogshop').'</strong><a href="'.esc_url('https://theimran.com/themes/wordpress-theme/wordpress-theme-for-blogging-and-ecommerce-store/blogshop-wordpress-theme-for-any-websites/').'"><span> '.__( 'BlogShop', 'blogshop' ).'</span></a>';
	}
}
/**
